...
'''
this is an open source program by Mr. Error (Rajib-Vau)
...
def banner():
	...
	print("%s║%s  Github   : https://github.com/Rajib-Vau  %s║"%(Z,B,Z))
	print("%s║%s  Telegram : https://t.me/Rajibvau69       %s║"%(Z,B,Z))
